...
Usage::
    ...
    client.flow.run("analyze_entities", {"nodes": result["data"]["nodes"]})
"""
...
from aindy_sdk.exceptions import NetworkError, _raise_for_status
...
class AINDYClient:
    ...
    def __init__(
        ...
        from aindy_sdk.flow import FlowAPI
