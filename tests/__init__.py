...
class TestClientRequest(unittest.TestCase):
    ...
    def test_successful_post_returns_json(self):
        ...
        with patch("aindy_sdk.client.urlopen", return_value=mock_resp):
    ...
    def test_get_with_params_builds_query_string(self):
        ...
        with patch("aindy_sdk.client.urlopen", return_value=mock_resp) as mock_open:
    ...
    def test_network_error_raises_NetworkError(self):
        ...
        c = _make_client()
        with patch("aindy_sdk.client.urlopen", side_effect=URLError("Connection refused")):
    ...
    def test_http_401_raises_AuthenticationError(self):
        ...
        with patch("aindy_sdk.client.urlopen", side_effect=err):
